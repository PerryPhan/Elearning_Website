...
<body>
    <div class="position-absolute d-flex" style="left:50%;top:50%;transform: translate(-50%,-50%);box-shadow: 0px 0px 10px rgba(0,0,0,.2);">
        <iframe src="${link}/pdf_for_curr/${curri.pdf}" width="100%" height="600px" class="border output" alt="Please F5 to see information">
      </iframe>
        <form:form action="curriculumUpdform.htm?id=${courseid}&currid=${curri.id }" method="POST" class="bg-white" style=" height:600px;width: 1200px;" enctype="multipart/form-data">
            <a class="btn my-3" href="curriculum.htm?id=${courseid}"><img src="${link}/img/Arrow 1.png" alt="back" width="30px"> Back to Admin page </a>
            <!-- <h2>Order by Date dec</h2> -->
            <h2 class="pl-3 text-center">
                Updating existed Curriculum
            </h2>
            <h3 class="text-primary text-center">${success}</h3>
            <div class="container w-75">
            	
                <div class="form-control d-flex">
                    <label class="w-25">Name</label>
                    <input type="text" name="name" class="w-75" value="${curri.name }">
                </div>
