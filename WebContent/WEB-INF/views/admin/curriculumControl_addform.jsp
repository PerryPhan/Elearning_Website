...
<head>
    <title>Udemy - AddCurriculum</title>
    <meta charset="UTF-8">
...
<body>
    <div class="position-absolute d-flex" style="left:50%;top:50%;transform: translate(-50%,-50%);box-shadow: 0px 0px 10px rgba(0,0,0,.2);">
        ...
        <form:form action="curriculumAddform.htm?id=${courseid}" method="POST" class="bg-white" style=" height:600px;width: 1200px;" enctype="multipart/form-data">
